...
void wk_exint_config(void) {
  ...
  gpio_exint_line_config(GPIO_PORT_SOURCE_GPIOC, GPIO_PINS_SOURCE6);
  ...
  gpio_exint_line_config(GPIO_PORT_SOURCE_GPIOD, GPIO_PINS_SOURCE12);
  ...
  gpio_exint_line_config(GPIO_PORT_SOURCE_GPIOD, GPIO_PINS_SOURCE13);
